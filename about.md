...
<section class="section">
  <div class="container">
    ...
    <h2 class="text-gradient mt-3">Technology Stack</h2>
    <div class="card-grid">
      <div class="card">
      ...
      <div class="card">
        <h3><i class="fas fa-database"></i> Data & Infrastructure</h3>
        <div class="tech-badges">
    ...
    <h2 class="text-gradient mt-3">Architecture Philosophy</h2>
    <div class="highlight-box">
      <p>I design systems that:</p>
